...
class JiraFieldsTests(unittest.TestCase):
    def test_builds_default_task_type_select_field(self) -> None:
        config = BotConfig(
            ...
            jira_epic_link_field="customfield_10010",
            jira_epic_name_field="customfield_10011",
            jira_sprint_field="customfield_10012",
            jira_task_type_field="customfield_10013",
            jira_default_task_type="Задача развития",
            jira_estimate_field="customfield_10014",
            jira_board_id=123,
            jira_default_epic_key="ABC-456",
            jira_default_epic_name="Default Epic",
            jira_default_sprint_query="[ABC:TEAM]",
            jira_default_assignee_key="user_key",
            jira_default_assignee_name="Иванов Иван",
            jira_default_assignee_email="ivanov@example.local",
        ...
        self.assertEqual(fields["customfield_10013"], {"value": "Задача развития"})
    ...
    def test_builds_estimate_select_field(self) -> None:
        ...
        self.assertEqual(fields["customfield_10014"], 3.0)
